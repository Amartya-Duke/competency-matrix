(function() {
    ...
    var count, target,
        ...
        saveProfileButton = app.getElement('#submit_profile_image'),
        emailErrorMessage = app.getElement('#email_error_placeholder'),
        nameErrorMessage = app.getElement('#name_error_placeholder'),
        addressErrorMessage = app.getElement('#address_error_placeholder'),
        emailErrorMessage = app.getElement('#email_error_palceholder'),
        emailErrorDiv = app.getElement('#email_error'),
        nameErrorDiv = app.getElement('#name_error'),
        addressErrorDiv = app.getElement('#address_error'),
        superviseeErrorMessage = app.getElement("#supervisee_name_error_palceholder"),
        superviseeErrorDiv = app.getElement("#supervisee_name_error");
    ...
    function deleteView(superviseesData) {
        ...
        for (var i = 0; i < deleteIcon.length; i++) {
            deleteIcon[i].addEventListener("click", deleteSuperviseeHandler);
            deleteIcon[i].data = superviseesData;
        }
    }

    function deleteSuperviseeHandler() {
        superviseesData = event.currentTarget.data;
    ...
    function editView(superviseesData) {
        ...
        for (var i = 0; i < editIcon.length; i++) {
            editIcon[i].addEventListener("click", superviseeEditHandler);
            editIcon[i].data = superviseesData;
        }
    }
    ...
    function superviseeEditHandler() {
        superviseesData = event.currentTarget.data;
    ...
    function registerDeleteEvent(superviseesData, empId) {
        ...
        deleteYes.addEventListener("click", superviseeDeleteHandler);
        deleteYes.data = superviseesData;
        deleteNo.addEventListener("click", deleteModalNohandler);
    }

    function superviseeDeleteHandler() {
        superviseesData = event.currentTarget.data;
        for (var i = 0; i < superviseesData.length; i++) {
            var deletedName = "";
    ...
    function editView(superviseesData) {
        ...
        for (var i = 0; i < editIcon.length; i++) {
            editIcon[i].addEventListener("click", editHandler);
            editIcon[i].data = superviseesData;
        }
    }
    ...
    function registerEditEvent(superviseesData, empName, empRole, empId) {
        ...
        saveButton.data=superviseesData;
        saveButton.name=empName;
        saveButton.role=empRole;
        saveButton.id=empId;
        sorting(superviseesData, "name");
...
function saveHandler() {
    superviseesData=event.currentTarget.data;
    empName=event.currentTarget.name;
    empRole=event.currentTarget.role;
    empId=event.currentTarget.id;
            ...
            if (takeSupervisee) {
                ...
                superviseeErrorMessage.innerHTML = "Name cannot be empty";
            }
        }
